...
**Figure 2.2:** Scatterplot of percentage of parsitemia against outcome variable (percentage of pathogen reads). We can identify a roughly linear relationship between the two variables. This supports the results that we got from the correlation matrix. 
</big>
