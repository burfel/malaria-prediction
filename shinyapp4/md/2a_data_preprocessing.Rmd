...
As the data was found to be skewed, ie not symmetric, see figure X [INSERT FIGURE], we tried different transformations (log, square root, inverse) to remove the skew, ie so that the probability of falling on either side of the distribution's mean is roughly equal. 
