                   ...
                   tabPanel("ANOVA",
                            ...
                            selectInput("model3_select",
                                        ...
                                        choices = c("Simple model with percentage of parasitemia" = "simple_paras2",
                                                    "Simple model with parasitemia density [1/µl]" = "simple_paras2_dens",
                                                    "Complex model with percentage of parasitemia and total white blood cell count" = "complex_paras2",
                                                    "Complex model with parasitemia density [1/µl] and total white blood cell count" = "complex_paras2_dens"
                                                    ),
                                        selected = "complex_paras2"),

                            selectInput("test_select",
                                        label = "Test",
                                        choices = c("Chisq" = "chisq",
                                                    "F" = "f",
                                                    "Rao" = "rao"),
                                        selected = "chisq"),
                            # br(),
