...
**Figure 3**: Malaria [prevalence](https://www.nobelprize.org/educational/medicine/malaria/readmore/global.html "the proportion of a population that at some point in their life have experienced this disease") on a global scale (from [5]) 
 
 
![malaria_piechart](../img/malaria_piechart.png) 
**Figure 2**: 9% of deaths globally among children under the age of 5 are caused by malaria; in Africa 20% of this group dies (from [6]). 
