...
**Figure 1:** Scatterplot of the data set: Number of total reads in the sample against the percentage that map to the pathogen. The numbers indicate the sample IDs. We can see that the pathogen percentage varies a lot (between almost 0% in sample 26 — most probably a still healthy person to 80%). We cannot identify any pattern that would indicate that the number of total reads in a sample is any correlated to the percentage of pathogen reads. It seems intuitive to assume that the number of reads we find in a sample is independent of the percentage of reads that map to the pathogen.
