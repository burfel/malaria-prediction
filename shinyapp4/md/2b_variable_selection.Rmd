...
```
This way we identified parasitemia percentage and white blood cell count. As alternative and equally informative variables we identified parasitemia density and the ensemble of different white blood cell types (lymphoctes, monocytes and neutrophils).
