...
**Figure 1:** Q-Q plot of the residuals of the simple model with percentage of parasite based on the fully complete data set (21 samples)
...
However, if we make the test to exclude some potential outlier samples, we do get slightly different slope coefficients (see figure 4), but 35 and 39 identified here do not seem to make any difference compared to the model on our 40 complete samples on the model variables.
