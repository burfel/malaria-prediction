...
<big>
In cases where for certain response variables the just tested assumptions do not hold, generalized linear models (GLM) are excellent at dealing with them. They are an extension of the linear regression model.
GLMs are recommended when
...
--->
Additionally, we used statistical methods from [3] to empirically identify an appropriate transformation, including a family of transformations that are indexed by a parameter proposed by Box and Cox (1964)[3].
</big>
