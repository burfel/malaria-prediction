...
## What is Malaria?
Malaria is an infectious disease caused by a few plasmodium species which are single-cell parasites that  get spread around by mosquitos.
...
| Figure 3: 9% of deaths globally among children under five are caused by malaria. In Africa, 20% of children under 5 die due to malaria [6][INSERT LINK HERE]. |

## Are there different types of Malaria?
Yes, there are 100 of plasmodium species but only 5 cause malaria disease in humans:
* P falciparum
* P vivax
* P malariae
* P ovale
...
The read depth, ie number of reds that map to the pathogen or to the host relative to the respective genome, is of special interest but often difficult to predict.
